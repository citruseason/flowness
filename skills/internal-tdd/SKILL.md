...
### 단계 4: COMMIT — 변경사항 커밋 및 푸시

GREEN 상태가 확인되면 즉시 커밋합니다:

1. 변경된 소스 및 테스트 파일을 스테이징합니다
2. 간결한 커밋 메시지를 작성합니다: `feat: {완료 기준 요약}`
3. 푸시합니다
...
**주의**: 테스트가 실패하는 상태에서는 절대 커밋하지 마세요. 반드시 GREEN 상태에서만 커밋합니다.

### 단계 5: 반복

다음 완료 기준으로 이동합니다. 단계 1-4를 반복합니다.
...
2. 버그를 수정합니다 (GREEN)
3. 필요시 리팩토링합니다
4. 커밋하고 푸시합니다: `fix: {bug description}`
